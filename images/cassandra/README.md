...
Lightweight, production-ready Apache Cassandra distributed database image based on Ubuntu 24.04. Built with OpenJDK 17 and Python 3. Designed for Kubernetes, built for everyone.
