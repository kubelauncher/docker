...
Lightweight, production-ready RabbitMQ message broker image based on Ubuntu 24.04. Includes the management UI and Prometheus metrics plugins enabled by default. Designed for Kubernetes, built for everyone.
